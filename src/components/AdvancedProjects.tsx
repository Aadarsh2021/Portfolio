...
const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "A cutting-edge portfolio website showcasing modern web development practices. Built with React 18, TypeScript, and featuring 3D animations, dark/light mode, advanced animations with Framer Motion, and optimized performance. Includes PWA capabilities and modern SEO practices.",
    technologies: ["React", "TypeScript", "Bootstrap", "Framer Motion", "Three.js"],
    category: 'web',
    icon: BsLaptop,
    image: "/images/portfolio.jpg",
    githubUrl: "https://github.com/Aadarsh2021/portfolio",
    liveUrl: "https://aadarsh-portfolio.vercel.app",
    status: 'completed',
    featured: true,
    year: 2024
  },
